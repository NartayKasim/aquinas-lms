...
const ViewCourse = props => {
    ...
    return (
        <div className="view-course">
            ...
            <ShowBlock type={COURSE} title={course.title} description={course.description} courseParam={props.match.params.courseID} key={uuidv4()} />

            {course.content.map((unit, idx) => <ShowBlock idx={idx} type={UNIT} title={unit.title} description={unit.description} courseParam={props.match.params.courseID} content={unit.content} key={uuidv4()} />)}
